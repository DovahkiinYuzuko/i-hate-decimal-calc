...
func isReservedFunc(name string) bool {
	switch name {
	case "sqrt", "sin", "cos", "tan", "log", "ln", "abs", "cbrt", "gcd", "lcm", "mod", "perm", "comb", "rand", "asin", "acos", "atan", "expand", "diff", "solve", "det", "inv", "transpose", "taylor", "sum", "dot", "cross", "norm", "grad", "div", "curl":
		return true
	default:
		return false
	}
